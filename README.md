Description
This is a simple shell project done as part of ALX projects for qualification of software engineering course offered by ALX Africa.

The project was completed by Richard and Enoch following a close collaboration.

Bellow is what is expected follwoing the completation of the project.
...
You should have an AUTHORS file at the root of your repository, listing all individuals having contributed content to the repository. Format, see Docker GitHub
